...
💡 Tip: The more specific your description, the better we can meet your needs`,
  ...
  'workspace.auditLog.upgrade.cta': 'View plans',
  'workspace.auditLog.upgrade.desc':
    'Audit logs are available on the Workspace Business plan for owner-level security review.',
  'workspace.auditLog.upgrade.title': 'Upgrade to Business to view audit logs',
  ...
  'workspace.member.budget.manage': 'Set budget',
  'workspace.member.budget.unlimited': 'Unlimited budget',
  'workspace.member.budget.usage': '{{used}} / {{limit}}M credits',
  'workspace.member.budgetModal.clear': 'Clear limit',
  'workspace.member.budgetModal.currentUsage': 'Current usage',
  'workspace.member.budgetModal.description':
    'Control how many workspace credits {{name}} can use in the current billing cycle.',
  'workspace.member.budgetModal.failed': 'Failed to update member budget',
  'workspace.member.budgetModal.limitHint':
    'Enter credits in millions. For example, 1.5 means 1.5M credits.',
  'workspace.member.budgetModal.limitLabel': 'Budget limit',
  'workspace.member.budgetModal.millionCredits': '{{value}}M credits',
  'workspace.member.budgetModal.save': 'Save budget',
  'workspace.member.budgetModal.success': 'Member budget updated',
  'workspace.member.budgetModal.title': 'Member budget',
