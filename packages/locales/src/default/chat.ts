export default {
  ...
  'cliInterruptedGuide.autoRetry.status':
    'Connection interrupted · retry {{attempt}}/{{max}} in {{seconds}}s',
  'cliInterruptedGuide.autoRetry.title': '{{name}} connection interrupted — retrying automatically…',
  'cliInterruptedGuide.desc':
    "{{name}}'s connection dropped mid-response. Retrying usually picks up where it left off.",
  ...
  'cliInterruptedGuide.title': '{{name}} connection was interrupted',
